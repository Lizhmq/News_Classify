...
word_freqs = {i: int_word_counts[i]*1.0 / total_count for i in int_word_counts.keys()}
...
with train_graph.as_default():
    ...
    loss = tf.nn.sampled_softmax_loss(
        softmax_w, softmax_b, labels, embed, n_sampled, vocab_size)
...
with train_graph.as_default():
    ...
    # valid_examples = [vocab_to_int['记者'],vocab_to_int['服务']]
    valid_examples = [vocab_to_int['警察'], vocab_to_int['篮球'], vocab_to_int['学生'], vocab_to_int['女人']]
        ...
        for x, y in batches:
            ...
            if iteration % 10000 == 0:
                ...
                for i in range(valid_size):
                    ...
                    print(log)
            iteration += 1
    save_path = saver.save(sess, "checkpoints/corpus.ckpt")
